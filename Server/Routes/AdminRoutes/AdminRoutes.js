...
const {getAllConsultations, approveConsultation, allClients, oneClient, rejected, pendingConsultations, adminDashboard, getOneConsultation} = require("../../Controllers/AdminControllers/AdminControllers");
