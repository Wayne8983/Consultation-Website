...
const getErrorMessage = (err) => {
  ...
  if (err.response?.status === 403) {
    return "This account is not allowed to view admin clients.";
  }
...
const AdminClients = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-2">
            Create clients, assign projects and schedule meetings.
          </p>
        </div>
        ...
        <Modal title="Create Client" onClose={closeModal}>
          <form onSubmit={createClient} className="space-y-4">
            ...
            <Input
              ...
              onChange={(value) =>
                setClientForm({ ...clientForm, password: value })
              }
            />
            ...
            <Input
              ...
              onChange={(value) =>
                setClientForm({ ...clientForm, company: value })
              }
            />
      ...
      {modalType === "project" && (
        <Modal
          title={`Create Project for ${selectedClient?.name}`}
          onClose={closeModal}
        >
          <form onSubmit={createProject} className="space-y-4">
            ...
            <Input
              ...
              onChange={(value) =>
                setProjectForm({ ...projectForm, deadline: value })
              }
            />
            ...
            <Input
              ...
              onChange={(value) =>
                setProjectForm({ ...projectForm, budget: value })
              }
            />
      ...
      {modalType === "meeting" && (
        <Modal
          title={`Schedule Meeting for ${selectedClient?.name}`}
          onClose={closeModal}
        >
          <form onSubmit={createMeeting} className="space-y-4">
            <Input
              ...
              onChange={(value) =>
                setMeetingForm({ ...meetingForm, title: value })
              }
            />
            ...
            <Textarea
              ...
              onChange={(value) =>
                setMeetingForm({ ...meetingForm, description: value })
              }
            />
            ...
            <Input
              ...
              onChange={(value) =>
                setMeetingForm({ ...meetingForm, meetingDate: value })
              }
            />
            ...
            <Input
              ...
              onChange={(value) =>
                setMeetingForm({ ...meetingForm, venue: value })
              }
            />
            ...
            <div className="rounded-2xl border border-red-500/20 bg-red-600/10 p-5">
              ...
              <div className="mt-4 text-sm text-gray-300">
                <p>
                  ...
                  {confirmAction.client.name}
                </p>

                <p>
                  <span className="text-gray-500">Email:</span>{" "}
                  {confirmAction.client.email}
                </p>

                <p>
                  <span className="text-gray-500">Current Status:</span>{" "}
                  {confirmAction.client.status}
                </p>
              </div>
            </div>
